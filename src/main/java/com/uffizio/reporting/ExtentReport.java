...
public class ExtentReport extends DriverFactory implements ITestListener {
    ...
    public void onStart(ITestContext testContext) {
        ...
        sparkReporter.config().setDocumentTitle("Trakzee_WATM");
        sparkReporter.config().setReportName("Trakzee_WATM");
        sparkReporter.config().setTheme(Theme.DARK);

        extentReports = new ExtentReports();
        extentReports.attachReporter(sparkReporter);
        extentReports.setSystemInfo("Applcation name", "https://qa.uffizio.com/");
    ...
    public void onTestSuccess(Scenario result) {
       ...
       // extentTest.assignCategory(result.getName().lines());
    ...
    public void onTestFailure(ITestResult result) {
		...
		try {
			if (DriverFactory.getDriver() != null) {
                captureScreen(DriverFactory.getDriver(), result.getName());
            } else {
